...
* `-41` and `-18`
* `-49` and `-32` <img src="../figures/check.png" width=15 height=15>
...
* `7`
* `17`
* `23` <img src="../figures/check.png" width=15 height=15>
...
* Leave it empty (no penalty)
* `1.043956`
* `1.035714` <img src="../figures/check.png" width=15 height=15>
* `1.046512`
* `1.040541`
...
* Leave it empty (no penalty)
* `-1.113537`
* `1.515625` <img src="../figures/check.png" width=15 height=15>
* `-1.914894`
* `-19.5000`
